...
module.exports = {
    ...
    options: [
        {
            name: 'channel',
            description: 'O canal para o qual voce deseja enviar',
    ...
    async execute({ inter, client }) { 
      ...
      if (Channel.type !== 0) return inter.editReply({ content: `Voce tem que enviar para um canal de texto.. ❌`, ephemeral: true})
