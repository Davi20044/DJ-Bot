...
module.exports = {
    ...
    async execute({ inter, client }) {
        ...
        const NoResultsEmbed = new EmbedBuilder()
            .setAuthor({ name: `Resultado não encontrado... Tente de novo ? ❌`})
            .setColor('#2f3136')
        ...
        try {
            ...
            const NoVoiceEmbed = new EmbedBuilder()
                .setAuthor({ name: `Não foi possivel entrar ao canal... Tente de novo ? ❌`})
                .setColor('#2f3136')
            ...
            const playEmbed = new EmbedBuilder()
                .setAuthor({ name: `Carregando sua ${res.playlist ? 'playlist' : 'Musica'} para a Fila... ✅`})
                .setColor('#2f3136')
