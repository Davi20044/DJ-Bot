...
module.exports = async ({ client, inter, queue }) => {
    ...
    try {
        ...
        if (!song) return inter.editReply({ content: `nenhuma letra encontrada ${queue.currentTrack.title}... Tente de novo ? ❌`, ephemeral: true });
        ...
        inter.editReply({ content: `Erro! Entre em contado com o Desenvolvedor! | ❌`, ephemeral: true });
    }
}